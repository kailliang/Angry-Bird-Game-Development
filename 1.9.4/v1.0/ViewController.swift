...
class ViewController: UIViewController, subviewDelegate{
    ...
    func changeSomething() {
        ...
        //dynamicAnimator = UIDynamicAnimator(referenceView: self.view)
         ...
         // remove birds after collision then recreate them randomly---------------
...
//score keeping----------------------------------
    @IBOutlet weak var ScoreKeeping: UILabel!
    func Scorekeeping(){
          sum = sum + 1
         ScoreKeeping.text = "Score: " + String(sum)
        ScoreKeeping.center = CGPoint(x: W/2, y: 10)
